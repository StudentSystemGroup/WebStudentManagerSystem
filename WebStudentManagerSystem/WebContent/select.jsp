...
<form action="select.do" method="post" name="form1" id="f2" autocomplete="off">
<table id="t3">
<tr><td id="z1">请输入待查询学生的学号：</td><td align="left"><input name="id" type="text" size="10"></td></tr>
</table>
...
<table id="t3">
<tr><td>
<input id="a3" type="submit" value="查询" onClick="return check(form1)">
</td></tr>
</table>
</form>
</div>
